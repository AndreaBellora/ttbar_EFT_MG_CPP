...
void Parameters_AAttbar_UFO::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
  ...
  mdl_xi6 = slha.get_block_entry("frblock", 6, 1.000000e-24); 
  mdl_xi5 = slha.get_block_entry("frblock", 5, 1.000000e-24); 
  mdl_xi4 = slha.get_block_entry("frblock", 4, 1.000000e-24); 
  mdl_xi3 = slha.get_block_entry("frblock", 3, 1.000000e-24); 
  mdl_xi2 = slha.get_block_entry("frblock", 2, 1.000000e-24); 
  mdl_xi1 = slha.get_block_entry("frblock", 1, 1.000000e-24); 
